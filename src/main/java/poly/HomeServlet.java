...
//value chỉ định đường dẫn URL  mà servlet sẽ lắng nghe. Khi người dùng truy cập vào URL "/hello-servlet", servlet này sẽ được gọi và thực thi.
...
public class HomeServlet extends HttpServlet {
   ...
   - Cách 2:
     ...
     */
        req.setAttribute("message","Xin chào các bạn!");
